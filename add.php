...
//This makes sure they did not leave any fields blank
	...
	if ( !$_POST['firstname']|| !$_POST['lastname'] || !$_POST['email'] || !$_POST['password'] || !$_POST['password2'] || !$_POST['address']              || !$_POST['telephone_number'] || !$_POST['road'] || !$_POST['zip']) {
...
//if the name exists it gives an error
	...
	if ($check2 != 0) {
		?>
		<p>Sorry, the username is already in use. <a href="add.php">Register</a>.</p>
		<?php
		exit();
	}
...
// this makes sure both passwords entered match
	...
	if ($_POST['password'] != $_POST['password2']) {
		?>
		<p>your password did not match <a href="add.php">Register</a>.</p>
		<?php
	}
...
// here we encrypt the password and add slashes if needed
	...
	if (!get_magic_quotes_gpc()) {
		...
		$_POST['passord'] = addslashes($_POST['password']);
...
// now we insert it into the database
	$insert = "INSERT INTO user_ (LastName,FirstName,TelNo,Email,Password,City,Road,ZipCode) 
	VALUES ('".$_POST['lastname']."','".$_POST['firstname']."','".$_POST['telephone_number']."','".$_POST['email']."','".$_POST['password']."',      '".$_POST['address']."','".$_POST['road']."','".$_POST['zip']."')";
	...
	<p>Thank you, you have registered - you may now <a href="LoginTest.php">login</a>.</p>
